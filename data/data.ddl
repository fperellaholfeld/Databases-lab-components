...
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (3, 1, 3, 250);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (4, 1, 2, 140);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (5, 1, 6, 200);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (6, 1, 3, 150);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (7, 1, 1, 185);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (8, 1, 0, 85);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (9, 1, 2, 100);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (10, 1, 3, 195);
...
DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (3, '2019-10-15 3:30:22', 855)
SELECT @orderId = @@IDENTITY
...
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 13, 3, 145)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 15, 2, 95)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 17, 4, 45);

DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (5, '2019-10-15 10:25:55', 1640)
SELECT @orderId = @@IDENTITY
...
-- Loads image data for product 1 - Needs to be changed??
