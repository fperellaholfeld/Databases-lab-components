...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Cold Brew Calculus',2,'600 pages',180.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Devil''s Food Dynamics',3,'350 pages',140.00);
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Java Java',4,'150 pages gluten free',200.00);
...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('Watermelon World Religion',6,'100 pages - vegitarian',85.00);



INSERT INTO warehouse(warehouseName) VALUES ('Main warehouse');
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (1, 1, 10, 140);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (2, 1, 10, 125);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (3, 1, 10, 180);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (4, 1, 10, 140);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (5, 1, 10, 200);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (6, 1, 10, 150);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (7, 1, 10, 185);
INSERT INTO productInventory(productId, warehouseId, quantity, price) VALUES (8, 1, 10, 85);
...
DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (1, '2019-10-15 10:25:55', 445.00)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 1, 1, 140)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 2, 1, 125)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 3, 1, 180);
...
DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (3, '2019-10-15 3:30:22', 2335.00)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 6, 2, 150)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 7, 11, 185);

DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (2, '2019-10-17 05:45:11', 730)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 3, 1, 180)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 5, 2, 200)
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 6, 1, 150)

DECLARE @orderId int
INSERT INTO ordersummary (customerId, orderDate, totalAmount) VALUES (5, '2019-10-15 10:25:55', 370)
SELECT @orderId = @@IDENTITY
INSERT INTO orderproduct (orderId, productId, quantity, price) VALUES (@orderId, 7, 2, 185)
